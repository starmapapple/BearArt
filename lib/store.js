...
import { getOrderRowById, getOrderRows, getProductRowById, getProductRows, insertOrderRow, insertProductRow, isPostgresEnabled } from "@/lib/postgres";
...
export async function createOrder(input) {
  ...
  const now = new Date().toISOString();
  const paymentMethod = input.paymentMethod || product.paymentMethods?.[0] || "virtual_account";
